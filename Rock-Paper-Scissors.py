...
root.title('Rock Paper Scissors by Sanjay G')
...
def final():
    ...
    if root.lcount>root.rcount:
        ...
        canvas.create_text(650,350,text = " Want to challenge again?",font = ("Comic Sans MS",16))
    else:
...
def main_menu():
    ...
    button3 = tk.Button(text = "Exit \U0001f44b",
                        borderwidth = 3,
                        width = 16,
                        height = 3,
                        bg = "#3a9fbf",
